...
public class GetLocalisation extends Service implements LocationListener {

    // Get Class Name
    private static String TAG = GetLocalisation.class.getName();
    ...
    public GetLocalisation(Context context) {
    ...
    public void stopUsingGPS() {
        if (locationManager != null) {
            ...
            locationManager.removeUpdates(GetLocalisation.this);
        }
    }
    ...
    public void onLocationChanged(Location location) {
        latitude = location.getLatitude();
        longitude = location.getLongitude();
        ProfileHead.sendGeol(longitude, latitude, this);
